...
5. The next step is change the message when the the sanke hits the edge. I want to change it to Your amazing score is "Score" + "!!!". To do this, I will need to change the code as well as add the excliamation points.- DONE
...
12. I would like to add "Score: " to the top of the window where the score count is kept!- DONE 
14. The name of the window needs to be changed to say "Snake Game". This has to do with the set caption line of code.-DONE 
